...
QBConfig.StatusInterval = 2.5 -- how often to check hunger/thirst status in minutes
...
QBConfig.Player = {}
QBConfig.Player.HungerRate = 10.5 -- Rate at which hunger goes down.
QBConfig.Player.ThirstRate = 10.5 -- Rate at which thirst goes down.
...
QBConfig.Server.Discord = "https://discord.gg/PSgRme6vSJ" -- Discord invite link
