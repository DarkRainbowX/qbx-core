...
function IsOptin(source)
    local license = GetPlayerIdentifierByType(source --[[@as string]], 'steam')
...
function IsPlayerBanned(source)
    local plicense = GetPlayerIdentifierByType(source --[[@as string]], 'steam')
...
local function ExploitBan(playerId, origin)
    ...
    CreateThread(function()
        InsertBanEntity({
            name = name,
            license = GetPlayerIdentifierByType(playerId --[[@as string]], 'steam'),
